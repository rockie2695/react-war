  ...
  return (
    <div className="grid md:grid-cols-11 grid-cols-2 md:gap-4 gap-2">
      <div className="md:col-span-4 h-full flex items-center">
        <input
          className="w-full h-10 border border-gray-300 text-center p-1 text-blue-600 font-bold text-lg rounded-lg"
          value={sideName.my}
          onChange={(e) =>
      ...
      <div className="md:col-span-4 h-full flex items-center">
        <input
          className="w-full h-10 border border-gray-300 text-center p-1 text-red-600 font-bold text-lg rounded-lg"
