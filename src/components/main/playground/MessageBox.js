...
const MessageBox = () => {
  ...
  return (
    <div
      id={"MessageBox"}
      className="hover:opacity-100 md:opacity-70 h-24 w-full overflow-y-auto border border-gray-300 rounded-lg text-xs transition-opacity duration-300 hover:shadow-md space-y-1"
    >
